...
public class Autor{
    ...
    private String nacionalidad;
                ...
                /*
                 * Atributo para la fecha de nacimiento del autor.
     ...
     * 
     * Si "orphanRemoval = true" (está activado), Hibernate eliminará el libro de la base de datos automáticamente.
     * 
     *      Ejemplo de uso:
